...
from labs.testing.worker import Worker
import unittest
...
class WorkerTests(unittest.TestCase):
    ...
    def test_init__when_valid_name_salary_energy__expect_correct_result(self):
    ...
    def test_get_info_when_valid_name_salary_energy__expect_correct_result(self):
        worker = Worker(self.valid_name, self.valid_salary, self.valid_energy)
    ...
    def test_work__when_energy_is_negative__expect_to_increase_money_by_salary(self):
